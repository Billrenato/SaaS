"""
Django settings for guardiao_fiscal project.
...
SECRET_KEY = 'django-insecure-jk)@hjwy2l_9))92mq*&q0!4^&w_l=+p&cpyyyer$bkd^-v5(c'
...
ROOT_URLCONF = 'guardiao_fiscal.urls'
...
WSGI_APPLICATION = 'guardiao_fiscal.wsgi.application'
